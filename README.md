...
>
> Docker: `docker run --rm ghcr.io/joshios-vry/veriumminer:1.4.9 -o stratum+tcp://mine.vericonomy.com:3333 -u VYourAddress.worker1 -p x -t 1`
...
**Version:** 1.4.9 (see `CMakeLists.txt`).
